      ...
      <nav className='bg-[#fef6f6] border-b-2 border-red-500'>
        ...
        <div className='container mx-auto flex flex-wrap items-center justify-between px-4 py-4'>
          ...
          <div className='z-30'>
            ...
            <div
              className='fixed top-0 left-0 h-full w-80 bg-white shadow-lg'
              style={{ display: 'none' }}
            >
              <div className='flex items-center justify-between p-4 border-b'>
                <div className='text-2xl inter'>
              ...
              <div className='bg-white'>
                ...
                <nav className='divide-y'>
                  <CLink
                    className='block px-4 py-3 hover:bg-gray-50 text-red-500'
                    href='/'
                  >
                    Accueil
                  </CLink>
          ...
          <div className='items-center space-x-4 hidden lg:flex'>
            ...
            <div className='z-30'>
              <CLink
                ...
                className=' hover:bg-gray-400 bg-gray-500 p-2 rounded-full relative text-white duration-200 cursor-pointer block md:hidden'
                aria-expanded='false'
              >
                <svg
                  className='w-6 h-6'
              ...
              >
                ...
                <div className='absolute bottom-0 left-0 right-0 p-4 border-t bg-white'>
                  ...
                  <div className='w-full'>
                    <button
                      disabled
                      className='opacity-50 cursor-not-allowed text-center w-full bg-blue-500 text-white py-2 px-4 rounded-lg transition-colors'
                    >
                      Vérifier
                    </button>
                  </div>
