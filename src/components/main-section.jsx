            ...
            <div className="grid grid-cols-2 gap-8 md:gap-20 xl:gap-8 place-items-center">
                <div className="flex flex-col order-2 gap-3 pt-6 space-y-4 col-span-full md:px-4 xl:order-1 xl:col-span-1 md:py-16">
                    ...
                    <div className="flex justify-center md:justify-start gap-4">
                        <a
                            href="https://app.intercocina.com/contact"
                        ...
                        <a
                            href="https://app.intercocina.com/shop"
                    ...
                    <div className="relative z-20 rounded-3xl animate__animated animate__zoomIn">
                        <div className="swiper header-swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                            <div className="swiper-wrapper">
                                ...
                                >
                                    <img
                                        src="https://app.intercocina.com/storage/01JJ6WE60R9FW4223BE2ZGEZT8.webp"
                                        className="rounded-3xl border-2"
                                        width="550"
                                        height="300"
                                        alt=""
                                ...
                                >
                                    <img
                                        src="https://app.intercocina.com/storage/01JJ6WG4STX8K98EDH1M4CE8H4.webp"
                                        className="rounded-3xl border-2"
                                        width="550"
                                        height="300"
                                        alt=""
                                ...
                                >
                                    <img
                                        src="https://app.intercocina.com/storage/01JJ6WH6RE41ZMGQPC22FMN4T2.webp"
                                        className="rounded-3xl border-2"
                                        width="550"
                                        height="300"
                                        alt=""
