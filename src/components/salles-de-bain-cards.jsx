...
export default function SallesDeBainCards() {
  ...
  const wardrobes = [
    ...
    },
    {
      ...
      description: 'Solution fonctionnelle pour dissimuler la plomberie et offrir un rangement optimisé. Sur mesure, durable et facile à intégrer dans tous les projets.',
      images: [
    ...
    },
    {
      ...
      description: 'Surface centrale de la salle de bain, résistante et élégante, entièrement personnalisable pour s’adapter aux besoins techniques et esthétiques',
      images: [
    ...
    },
    {
      ...
      description: 'Une colonne fonctionnelle qui maximise le rangement vertical tout en conservant un design élégant et moderne, idéale pour optimiser l’espace.',
      images: [
        '/imgs/placard/placard-dressing.png',
        '/imgs/placard/placard-dressing-1.png',
        '/imgs/placard/placard-dressing-2.png',
