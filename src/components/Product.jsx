    ...
    return (
        <div>
                ...
                !data ?
                    ...
                    (<div className="flex flex-col min-[400px]:flex-row min-[400px]:items-center mb-5 gap-y-3 flex-wrap">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="ml-3 font-semibold text-lg text-green-600"> {product.status} </span>
                        </div>
                        ...
                        {colors.map((color, index) => (
                            ...
                            >
                                ...
                                <label htmlFor={`color-${color.id}`}
                                    className="inline-flex items-center justify-between w-full p-4 text-gray-500 border-gray-500 rounded-lg cursor-pointer peer-checked:border-red-600 peer-checked:border-4 border-2 peer-checked:text-red-600 hover:text-gray-600 hover:bg-gray-100"
                                    style={{ backgroundImage: `url('https://intercocina.com/storage/public/${color.image}')` }}
                                />
                                <div
                                    id={`tooltip-${color.id}`} // Unique ID for each tooltip
            ...
            {!special &&
                heights.length > 0 && (
                    <div className='text-left'>
                        <div className="font-bold">Hauteur {product.unit ? `(${product.unit})` : ""}</div>
...

            {
                !special &&
                    widths.length > 0 ?
                    (<div className='text-left'>
                        <div className="font-bold">Largeur {product.unit ? `(${product.unit})` : ""}</div>
                        <ul className="flex flex-wrap w-full gap-3">
