...
const SectionConver = () => {
  return (
    <section className='relative bg-gradient-to-br from-blue-900 to-gray-800 text-white overflow-hidden'>
      ...
      <Image src='/icons/B2B.svg' className="absolute right-10 top-4 z-10 hidden md:block" width={100} height={100} alt="b2b" />
          ...
          {/* <div className='w-full hidden md:block md:w-1/2 md:pl-12'>
            ...
            >
              ...
              <SwiperSlide>
                <div className='swiper-zoom-container rounded-xl overflow-hidden flex items-center justify-center w-full'>
                  <Image
                    src='https://app.intercocina.com/storage/01JJ9RNXMMA92VV2PMMFH307XC.png'
                    className='h-96 w-auto object-center'
