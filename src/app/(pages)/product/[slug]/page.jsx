      ...
      <div className="mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
        ...
        {(Object.keys(options).length > 0 || String(product.content).length > 10) && (
          <div className="rounded-2xl border border-stone-200 shadow-sm bg-gradient-to-b from-white to-stone-50 p-4 mt-4 space-y-4">
            ...
            {(({ 11: ["/imgs/fiche-technique-caisson/stone.png", "Caisson de cuisine Blanc"], 1: ["/imgs/fiche-technique-caisson/blanc.png", "Caisson de cuisine Hydrofuge Ston"], 12: ["/imgs/fiche-technique-caisson/granada.png", "Caisson TERRA"] }[+product?.type?.category_id]) || []).length > 0 && <Image src={({ 11: ["/imgs/fiche-technique-caisson/stone.png", "Caisson de cuisine Blanc"], 1: ["/imgs/fiche-technique-caisson/blanc.png", "Caisson de cuisine Hydrofuge Ston"], 12: ["/imgs/fiche-technique-caisson/granada.png", "Caisson TERRA"] }[+product?.type?.category_id])[0]} alt={({ 11: ["/imgs/fiche-technique-caisson/stone.png", "Caisson de cuisine Blanc"], 1: ["/imgs/fiche-technique-caisson/blanc.png", "Caisson de cuisine Hydrofuge Ston"], 12: ["/imgs/fiche-technique-caisson/granada.png", "Caisson Hydrofuge Granada"] }[+product?.type?.category_id])[1]} className="w-full" width={1000} height={1000} />}
